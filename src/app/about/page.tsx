    ...
    <div className="min-h-screen bg-white text-neutral-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 md:py-24 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 md: gap-32 mb-20 md:mb-40 items-center">
            ...
            <div className="flex flex-col justify-center space-y-6 md:space-y-8">
              <div>
                ...
                <div className="w-16 md:w-24 h-px bg-neutral-900 mb-6 md:mb-8"></div>
              </div>

              {/* NEW SHORTENED BIOGRAPHY CONTENT */}
              <div className="space-y-6 text-base md:text-lg font-light leading-relaxed text-neutral-600">
                <p>
          ...
          {/* Stats Section */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-neutral-900/10 mb-16 md:mb-32">
            {stats.map((stat) => (
              <div
                key={stat.id}
                // MODIFIED: Reduced p-12 to p-6 for mobile
                className="relative bg-white p-6 md:p-12 group cursor-pointer overflow-hidden"
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className="flex justify-center mb-4 md:mb-6">
                    ...
                    <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-neutral-900 rounded-full flex items-center justify-center group-hover:rotate-180 transition-transform duration-500">
          ...
          {/* Philosophy Section */}
          <div className="relative border-2 border-neutral-900/20 p-8 md:p-16 lg:p-20 bg-neutral-50">
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="text-5xl md:text-7xl font-serif text-neutral-900 leading-none mb-4 md:mb-8">
                &ldquo;
              </div>
              {/* MODIFIED: Reduced text-3xl to text-xl for mobile */}
              <blockquote className="text-xl md:text-3xl font-extralight leading-relaxed mb-6 md:mb-8 text-neutral-700">
              ...
              <cite className="text-sm tracking-[0.3em] uppercase text-neutral-500 not-italic">
          ...
          <div className="mt-16 md:mt-32 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="space-y-6">
              ...
              <div className="w-12 h-12 md:w-16 md:h-16 border-2 border-neutral-900 rounded-full flex items-center justify-center text-xl md:text-2xl font-extralight">
                01
              </div>
